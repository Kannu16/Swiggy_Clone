...
import RestroContext from "../Utils/RestroContext.jsx";
import { filterData } from "../Utils/Helper.jsx";

const NavBar = () => {
  const RestrooData = useContext(RestroContext);
  const [text, setText] = useState("");
  const allList = RestrooData.allList;
  const setList = RestrooData.setList;

  return (
    <>
      <nav
        className="navbar navbar-expand-lg bg-body-tertiary fixed-top my-navbar"
        style={{ height: "80px" }}
      >
        <div className="container">
          <div>
            ...
            <Link className="navbar-brand" to="/">
              <b className="fs-5 ms-4 me-2">Other</b>{" "}
              <span className="fs-6">Banglore, karnataka India</span>
            </Link>
          </div>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav  ms-auto">
              <a
                className="nav-link me-5 fw-bold search"
                href="#sdsaf"
                aria-current="page"
              ...
              <a className="nav-link me-5 fw-bold offers" href="#Sdfsa">
                <svg
                  className="_1GTCc me-3"
                  viewBox="0 0 32 32"
                  height="19"
                  width="19"
                  fill="#686b78"
              ...
              <a className="nav-link me-5 fw-bold help" href="/">
                <svg
                  className="_1GTCc me-3"
                  viewBox="6 -1 12 25"
                  height="19"
              ...
              <a
                href="#Style"
                id="liveToastBtn"
                className="nav-link me-5 fw-bold sign-in"
              >
                <svg
                  className="_1GTCc me-3"
                  viewBox="6 0 12 24"
              ...
              <Link to="/cart" className="nav-link me-5 fw-bold cart">
                <svg
                  className="_1GTCc _2MSid me-3"
                  viewBox="-1 0 37 32"
                  height="20"
                  width="20"
                  fill="#686b78"
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button
                ...
                data-bs-dismiss="modal"
                onClick={() => {
                  filterData(allList, text, setList);
                }}
              >
                Search
              </button>
